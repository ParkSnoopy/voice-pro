...
class AbusAudio:
    ...
    def trim_silence_audio(
        ...
        # 시작과 끝 부분의 무음 인덱스 탐지
        start_index = detect_first_sound_index(
            audio, start_silence_threshold, chunk_size
        )
    ...
    def trim_silence_file(
        ...
        """
        audio = AbusAudio.trim_silence_audio(
            input_file,
            start_silence_threshold,
