...
class WhisperInference:
    ...
    def release_memory():
        gc.collect()
        logger.debug("[abus_asr_whisper.py] release_memory - OK!! ")
    ...
    def transcribe_live(
        ...
        try:
            ...
            logger.error(
                f"[abus_asr_whisper.py] transcribe_live - An error occurred: {e}"
            )
            return None, None
        finally:
            self.release_memory()
    ...
    def transcribe_file(
        ...
        try:
            ...
            logger.error(
                f"[abus_asr_whisper.py] transcribe_file - An error occurred: {e}"
            )
        finally:
            self.model = None
            self.release_memory()
