...
class GradioEdgeTTS:
    ...
    def gradio_tts_dubbing(
        ...
        logger.debug(
            f"[gradio_tts_edge.py] gradio_tts_dubbing - text = {text}, \
        ...
        input_text = text
        logger.debug(
            f"[gradio_tts_edge.py] gradio_tts_dubbing - input_text: {input_text}"
        )
