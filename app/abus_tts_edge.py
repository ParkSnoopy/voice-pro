...
class EdgeTTS:
    ...
    async def generate_audio(self, text, voice, output_file, rate=0, volume=0, pitch=0):
        ...
        logger.debug(
            f"[abus_tts_edge.py] generate_audio - text = {text}, voice = {voice}, rate_options = {rate_options}, volume_options = {volume_options}, pitch_options = {pitch_options}"
        )
        communicate = edge_tts.Communicate(
            text, voice, rate=rate_options, volume=volume_options, pitch=pitch_options
        )
    ...
    def request_tts(
        ...
        logger.debug(
            f"[abus_tts_edge.py] request_tts - line = {line}, voice_name = {voice_name}"
        )
        ...
        logger.debug(
            f"[abus_tts_edge.py] request_tts - output_voice_file = {output_voice_file}"
        )
