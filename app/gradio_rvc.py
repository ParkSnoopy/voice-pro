...
class GradioRVC:
    ...
    def gradio_upload_source(
        ...
        try:
            ...
            logger.error(
                f"[GradioRVC] gradio_upload_source - Error transcribing file: {e}"
            )
            gr.Warning(f"{e}")
            return None, None, None
    ...
    def gradio_rvc_dubbing(
        ...
        try:
            ...
            mixed_audio_file = path_add_postfix(
                source_audio_file, f"_mixed_{rvc_voice}"
            )
            ffmpeg_mix_audio(
                aidub_audio_file,
                denoise_inst_path,
            ...
            logger.error(
                f"[GradioRVC] gradio_rvc_dubbing - Error transcribing file: {e}"
            )
            gr.Warning(f"{e}")
            return None, None, None
