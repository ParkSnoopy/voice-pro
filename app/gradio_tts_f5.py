...
class GradioF5TTS:
    ...
    def gradio_tts_dubbing_single(
        ...
        logger.debug(
            f"[gradio_tts_f5.py] gradio_tts_dubbing_single - input_text: {input_text}"
        )

        try:
            dubbing_file = os.path.join(
                path_dubbing_folder(), path_new_filename(f".{audio_format}")
            )
    ...
    def gradio_tts_dubbing_multi(
        ...
        input_text = dubbing_text
        logger.debug(
            f"[gradio_tts_f5.py] gradio_tts_dubbing_multi - input_text: {input_text}"
        )
