...
group.add_argument(
    "--loader",
    type=str,
    help="Choose the model loader manually, otherwise, it will get autodetected. Valid options: Transformers, llama.cpp, llamacpp_HF, ExLlamav2_HF, ExLlamav2, AutoGPTQ, AutoAWQ, GPTQ-for-LLaMa, ctransformers, QuIP#.",
)
...
group.add_argument(
    "--cache_4bit", action="store_true", help="Use Q4 cache to save VRAM."
)
group.add_argument(
...
group.add_argument(
    "--disable_exllamav2", action="store_true", help="Disable ExLlamav2 kernel."
)
